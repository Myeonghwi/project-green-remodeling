...
:                  "nolimit" if unlimited (used when calling readVarsESO)
 ...
 set input_path=%program_path%ProcessFiles\Progress\84m2\
 set output_path=%program_path%ProcessFiles\Outputs\
...
:exe
 ...
 echo IDD file    : %program_path%ProcessFiles\Progress\84m2\Energy+.idd
